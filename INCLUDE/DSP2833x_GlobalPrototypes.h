...
extern unsigned char  SEGData[];//1-9
extern unsigned char  SEGDataDp[]; //有小数点只用于地址0xc1
extern void Init_KEY_GPIO(void);
extern void InitEPwm4(void);
extern void Init_FSPLED_GPIO(void);
extern void Init_VILED_GPIO(void);
extern void Config_ADC(void);
extern void V_Display(Uint16 data);
extern void I_Display(Uint16 data);
extern void A_Display(Uint16 data);
extern void F_Display(Uint16 data);
